...
(function () {
  ...
  const TRANS = {
    ...
    ar: {
      ...
      services_intro: 'نقدم في "عون المعالي" منظومة شاملة من الخدمات المصممة لتلبية تطلعات الأفراد، الشركات، والمستثمرين بكفاءة وموثوقية عالية.',
      countdown_day: 'يوم',
      countdown_hour: 'ساعة',
      countdown_min: 'دقيقة',
      countdown_sec: 'ثانية',
      ...
      footer_serv: 'خدماتنا',
      footer_copy: '© 2026 شركة عون المعالي للتطوير والاستثمار العقاري. جميع الحقوق محفوظة.',
